...
Dividir dos números
Salir
El programa debe ejecutarse en un bucle do-while hasta que el usuario seleccione la opción de salir.
Después de realizar cada operación, el resultado debe mostrarse en consola y luego el menú debe volver a mostrarse.
Si el usuario introduce una opción no válida, el programa debe indicarlo y volver a mostrar el menú.
Condiciones:
